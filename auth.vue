<template>
	<view class="">
		...
		<view class=""><input :value="language" /></view>
		<view class=""><input :value="country" /></view>
		<view class=""><input :value="headimgurl" /></view>
		<view class=""><input :value="province" /></view>
		<view class=""><input :value="city" /></view>
	</view>
</template>
